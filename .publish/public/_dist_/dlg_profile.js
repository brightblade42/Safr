...
export function EditProfileDlg(props) {
  let state = props.state;
  let funcs = props.funcs;
  function is_creating_or_editing() {
    return state.profile_action_state.type === "Creating" || state.profile_action_state.type === "Editing";
  }
  function do_cancel() {
    return;
  }
  return /* @__PURE__ */ React.createElement(Transition.Root, {
    show: is_creating_or_editing(),
    as: Fragment
