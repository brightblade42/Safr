...
import EditProfile from "./dlg_profile.js";
...
export function VideoEditor(props) {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(EditProfile, {
    state,
    funcs: profile_funcs
  }), /* @__PURE__ */ React.createElement("div", {
    className: "flex"
