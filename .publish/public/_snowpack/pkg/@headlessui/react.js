...
var reducers$2 = (_reducers$2 = {}, _reducers$2[ActionTypes$2.CloseMenu] = function (state) {
  if (state.menuState === MenuStates.Closed) return state;
  return _extends({}, state, {
    activeItemIndex: null,
    menuState: MenuStates.Closed
  });
}, _reducers$2[ActionTypes$2.OpenMenu] = function (state) {
  if (state.menuState === MenuStates.Open) return state;
  return _extends({}, state, {
    menuState: MenuStates.Open
  });
}, _reducers$2[ActionTypes$2.GoToItem] = function (state, action) {
...
}, _reducers$2[ActionTypes$2.RegisterItem] = function (state, action) {
  return _extends({}, state, {
...
}, _reducers$2[ActionTypes$2.UnregisterItem] = function (state, action) {
  ...
  var handleKeyDown = react.useCallback(function (event) {
    switch (event.key) {
      ...
      case Keys.ArrowDown:
        ...
        event.stopPropagation();
        dispatch({
          type: ActionTypes$2.OpenMenu
        });
        d.nextFrame(function () {
          return dispatch({
            type: ActionTypes$2.GoToItem,
            focus: Focus$1.First
          });
        });
        break;
...
function Item(props) {
  ...
  useIsoMorphicEffect(function () {
    dispatch({
      type: ActionTypes$2.RegisterItem,
      id: id,
      dataRef: bag
    });
    return function () {
      return dispatch({
        type: ActionTypes$2.UnregisterItem,
        id: id
      });
    };
  }, [bag, id]);
...
export { Dialog, Listbox, Menu, Transition };
